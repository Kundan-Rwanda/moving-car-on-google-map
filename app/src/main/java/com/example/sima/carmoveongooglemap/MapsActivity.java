...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                destination=destination.replace( " ","+");//Replace space to + to make proper url
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in atitude and Longitude of the Kicukiro city of Rwanda in other units:
        //Unit 	Latitude 	Longitude

        //137 nguyen van linh, start location
        final LatLng sydney = new LatLng(16.065997, 108.21553);
        ...
        try{
            requestUrl="https://maps.googleapis.com/maps/api/directions/json?"+
                    ...
                    "key="+getResources().getString(R.string.google_map_direction_key);
...
;                                }
    ...
    // getBearing is a method to calculate the proper position to rotate car
